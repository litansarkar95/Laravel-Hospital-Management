...
<div class="">
      	...
      	<div class="col-md-5 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2"  action="{{ route('doctor_insert') }}" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                            @csrf
                                        ...
                                        <div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="specialist">Specialist<span class="required">*</span>
											</label>
											<div class="col-md-9 col-sm-9 ">
                                         
												<select type="text" id="specialist"   name="specialist"  class="form-control ">
                                        ...
                                        <div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="file">Picture<span class="required">*</span>
											</label>
											<div class="col-md-9 col-sm-9 ">
												<input type="file" id="file" value="{{old('file')}}"  name="file"  class="form-control ">
											</div>
										</div>
